...
def fun_arranque(request): # process url_arranque
  ...
  while True:
    ...
    try:
      partido = Partido_enJuego.objects.get(empezado=False, desconectado=False) #busca el primer partido que cumple las dos condiciones
